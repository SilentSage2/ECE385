...
module lab7_soc_mm_interconnect_0 (
	...
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> key2_s1_agent:cp_channel
	...
	wire  [106:0] cmd_demux_001_src6_data;                                                            // cmd_demux_001:src6_data -> cmd_mux_008:sink1_data
	wire          cmd_demux_001_src6_ready;                                                           // cmd_mux_008:sink1_ready -> cmd_demux_001:src6_ready
	wire    [8:0] cmd_demux_001_src6_channel;                                                         // cmd_demux_001:src6_channel -> cmd_mux_008:sink1_channel
	...
	wire  [106:0] rsp_demux_008_src1_data;                                                            // rsp_demux_008:src1_data -> rsp_mux_001:sink6_data
	wire          rsp_demux_008_src1_ready;                                                           // rsp_mux_001:sink6_ready -> rsp_demux_008:src1_ready
	wire    [8:0] rsp_demux_008_src1_channel;                                                         // rsp_demux_008:src1_channel -> rsp_mux_001:sink6_channel
